...
inline constexpr Glyph5x7 kFont5x7Glyphs[] = {
    ...
    {',', {0x00, 0x50, 0x30, 0x00, 0x00}}, {'.', {0x00, 0x00, 0x60, 0x60, 0x00}},
    {':', {0x00, 0x36, 0x36, 0x00, 0x00}}, {';', {0x00, 0x56, 0x36, 0x00, 0x00}},
    {'/', {0x40, 0x20, 0x10, 0x08, 0x04}}, {'<', {0x08, 0x14, 0x22, 0x41, 0x00}},
    {'=', {0x14, 0x14, 0x14, 0x14, 0x14}}, {'>', {0x00, 0x41, 0x22, 0x14, 0x08}},
    {'?', {0x02, 0x01, 0x51, 0x09, 0x06}}, {'@', {0x32, 0x49, 0x79, 0x41, 0x3E}},
    {'[', {0x7F, 0x41, 0x41, 0x00, 0x00}}, {'\\', {0x02, 0x04, 0x08, 0x10, 0x20}},
    {']', {0x41, 0x41, 0x7F, 0x00, 0x00}}, {'_', {0x40, 0x40, 0x40, 0x40, 0x40}},
    {'|', {0x00, 0x00, 0x7F, 0x00, 0x00}}, {'0', {0x3E, 0x51, 0x49, 0x45, 0x3E}},
    ...
    {'Z', {0x61, 0x51, 0x49, 0x45, 0x43}}, {'a', {0x20, 0x54, 0x54, 0x54, 0x78}},
...
/// @brief Returns the compact 5x7 glyph descriptor for one character.
/// @details Missing characters fall back to the first table entry so the renderer always gets a
/// valid glyph pointer.
inline const Glyph5x7* lookup(char c)
{
    for (const auto& g : kFont5x7Glyphs)
    {
        if (g.c == c)
        {
            return &g;
...
/// @brief Exposes the 5x7 glyph lookup through the shared `fonts` namespace.
/// @details Callers outside the table namespace use this wrapper so font selection code can stay
